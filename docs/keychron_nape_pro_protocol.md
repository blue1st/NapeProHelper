...
| ボタン名 | ボタンID | 物理位置 | 配列インデックスと参照先 |
| :--- | :--- | :--- | :--- |
| **M1** | `1` | 左メインボタン | `keycodes[7]` (USB/Pass-through: `0x7E29` 左クリック) / `keycodes[0]` |
| **M2** | `2` | 右メインボタン | `keycodes[9]` (USB/Pass-through: `0x7E29` 右クリック) / `keycodes[1]` |
| **01 (G1)** | `3` | サイド左下 | `keycodes[5]` / `keycodes[12]` (標準: `0x00D2` 戻る) または `keycodes[9]` |
| **02 (G2)** | `4` | サイド右下 | `keycodes[10]` / `keycodes[12]` (標準: `0x7E2D` DPI切替) |
| **03 (G3)** | `5` | サイド左上 | `keycodes[6]` / `keycodes[13]` (標準: `0x522B` ボールスクロール) または `keycodes[11]` |
| **04 (G4)** | `6` | サイド右上 | `keycodes[0]` / `keycodes[7]` (標準: `0x522A` 8方向切替) または `keycodes[12]` |
| **スクロール (上)** | `7` | リング上回転 | `keycodes[7]` (標準: `0x7E2B` Vol_Up) または `keycodes[1]` |
| **スクロール (下)** | `8` | リング下回転 | `keycodes[8]` (標準: `0x7E2C` Vol_Down) または `keycodes[3]` |
