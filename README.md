...
**NapePro Helper** は、トラックボール内蔵の左右分離型トラックボールデバイス **Keychron Nape Pro** のためのシステムトレイ・ヘルパーアプリケーションです。

Keychron Nape Pro は、左右セパレート構造による自然なタイピング姿勢と、中央に配置されたトラックボールによるスムーズなポインタ操作を両立したトラックボールデバイスです。
